            ...
            switch (_a.label) {
                case 0:
                    ...
                    returnMessage = function () {
                        var selectMenuOptions = Array.from(typedef_1.DungeonItemInfoChart.keys()).map(function (_itemName) {
                            var _a, _b;
                            var itemName = _itemName;
                            var itemInInv = authorUserData.inventory.find(function (_i) { return _i.type === itemName; });
                            return {
                                emoji: ((_a = typedef_1.DungeonItemInfoChart.get(itemName)) === null || _a === void 0 ? void 0 : _a.emoji) || typedef_1.EMOJI_WHITEB,
                                label: (0, Utility_1.formalize)(itemName) + " x" + ((itemInInv === null || itemInInv === void 0 ? void 0 : itemInInv.uses) || 0),
                                description: "Buy $" + ((_b = typedef_1.DungeonItemInfoChart.get(itemName)) === null || _b === void 0 ? void 0 : _b.prize),
                                value: itemName,
                            };
                        });
                    ...
                    listen = function () {
                        (0, Utility_1.setUpInteractionCollect)(shopMessage, function (_itr) { return __awaiter(void 0, void 0, void 0, function () {
                            var itemBought_1, cost, itemInInv, _err_1;
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        timeout = getTimeout();
                                        itemBought_1 = _itr.values[0];
                                        cost = (_a = typedef_1.DungeonItemInfoChart.get(itemBought_1)) === null || _a === void 0 ? void 0 : _a.prize;
                                        ...
                                        return [3 /*break*/, 4];
                                    case 2:
                                        if (!(cost !== undefined && authorUserData.money - cost >= 0)) return [3 /*break*/, 4];
                                        itemInInv = authorUserData.inventory.find(function (_i) { return _i.type === itemBought_1; });
