...
function Test() {
    return __awaiter(this, void 0, void 0, function () {
        var CSMap, AINodeMap, nodePriorQueue, x, y, coordString, node, results, AINode, ax, ay, i, coordString, node;
        return __generator(this, function (_a) {
            CSMap = getMapFromCS({
                "0": {
                    "7": {
                        "class": typedef_1.Class.Block,
                        "team": "block",
                        "botType": 1,
                        "x": 0,
                        "y": 7
            ...
            AINodeMap = new Map();
            nodePriorQueue = new MinHeap_1.MinHeap(function (n) { return (n === null || n === void 0 ? void 0 : n.totalC) || null; });
            for (x = 0; x < 11; x++) {
                for (y = 0; y < 11; y++) {
                    coordString = getCoordString({ x: x, y: y });
                    if (!CSMap.has(coordString)) {
                        node = getNewNode(x, y, { x: 3, y: 2 }, Number.POSITIVE_INFINITY);
            ...
            while (AINode) {
                for (i = 0; i < 4; i++) {
                    coordString = getCoordString({ x: AINode.x + ax[i], y: AINode.y + ay[i] });
                    if (AINodeMap.has(coordString)) {
                        node = AINodeMap.get(coordString);
